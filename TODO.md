...
- [ ] [UX/UI] Script should auto-verify, not require operator commands (Low)
- [ ] [Reliability] Release file lock before os.replace on Windows (Medium)
- [ ] [UX/UI] Explicit checkpoint print before operator restarts bot (Low)
