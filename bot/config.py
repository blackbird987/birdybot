...
- Your turn ENDS when you send your final message. The process EXITS. You do NOT keep running, polling, watching, or waiting afterward. NOTHING resumes you — not the deploy system, not CI, not a webhook, not a "notification". There is exactly ONE way to continue after an external event: YOU schedule a self-wake (see the "Continuing After Your Turn" section below, present for non-worktree sessions).
